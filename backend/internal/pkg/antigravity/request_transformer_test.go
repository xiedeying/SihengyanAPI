...
func TestBuildTools_DropsWebSearchWhenFunctionsPresent(t *testing.T) {
	tools := []ClaudeTool{
		{
			Name:        "get_weather",
			Description: "Get weather information",
	...
	require.Nil(t, result[0].CodeExecution)
}

func TestBuildTools_PreservesWebSearchOnly(t *testing.T) {
