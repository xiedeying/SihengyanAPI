<template>
  <div>
    ...
    <div class="relative mb-3">
      ...
      <div
        v-if="showDropdown"
        class="absolute left-0 right-0 top-full z-[var(--ui-z-menu)] mt-1 rounded-lg border border-gray-200 bg-white shadow-lg dark:border-dark-600 dark:bg-dark-700"
      >
