<template>
  <div class="flex flex-none">
    ...
    <button
      @click="openModal"
      class="relative flex h-11 w-11 flex-none items-center justify-center rounded-lg text-gray-600 transition-colors hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-dark-800"
