  ...
  >
    ...
    <div class="mb-6">
      <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/30">
        <svg class="h-6 w-6 text-red-600 dark:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
    ...
    <form v-else id="totp-disable-form" @submit.prevent="handleDisable" class="space-y-4">
          <!-- Email verification -->
    ...
    <template #footer>
      ...
      <button
        ...
        :disabled="loading || !canSubmit || methodLoading"
      >
