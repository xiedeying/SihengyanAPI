...
const anthropicPresetMappings = [
  ...
  { label: 'Fable 5', from: 'claude-fable-5', to: 'claude-fable-5', color: 'bg-violet-100 text-violet-700 hover:bg-violet-200 dark:bg-violet-900/30 dark:text-violet-400' },
...
const grokPresetMappings = [
  ...
  { label: 'Grok 3 Mini', from: 'grok-3-mini', to: 'grok-3-mini', color: 'bg-slate-100 text-slate-700 hover:bg-slate-200 dark:bg-slate-800/50 dark:text-slate-300' },
  { label: 'Grok 3 Mini Fast', from: 'grok-3-mini-fast', to: 'grok-3-mini-fast', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
  ...
  { label: '4.20 Multi Agent', from: 'grok-4.20-multi-agent', to: 'grok-4.20-multi-agent-0309', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
  ...
  { label: 'Imagine Video 1.5', from: 'grok-imagine-video-1.5', to: 'grok-imagine-video-1.5', color: 'bg-amber-100 text-amber-700 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400' },
  { label: 'Imagine Video 1.5 Preview', from: 'grok-video-1.5', to: 'grok-imagine-video-1.5-preview', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' }
]
...
const antigravityPresetMappings = [
  ...
  { label: 'Sonnet 5', from: 'claude-sonnet-5', to: 'claude-sonnet-5', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
...
const bedrockPresetMappings = [
  ...
  { label: 'Fable 5', from: 'claude-fable-5', to: 'anthropic.claude-fable-5', color: 'bg-violet-100 text-violet-700 hover:bg-violet-200 dark:bg-violet-900/30 dark:text-violet-400' },
